...
export default defineConfig({
  ...
  webServer: [
    { command: '../../.venv/bin/python -m uvicorn app.main:app --app-dir ../../services/api --port 8103', url: 'http://127.0.0.1:8103/healthz', env: { DATABASE_URL: 'sqlite://', CORS_ORIGINS: 'http://127.0.0.1:3103' } },
